...
<template>
    <div>
        <div class="clearfix MB10">
            <div class="fl">
                <p class="bilitit">添加档案区域</p>
            </div>
            <div class="fr">
                <Button class="add-btn" @click="addLocation" >
                    <Icon type="plus-round"></Icon>&nbsp;添加区域
                </Button>
            </div>
        </div>
        ...
        <div class="rukucont ">
            ...
            <tr v-for="(line, index) in rack">
                ...
                <td> 
                 ...
                 <td> 
                    <div v-for="(vl, k) in line.rack"  >
                        <div class="QYcont tablerow1 clearfix" v-for="(vls, n) in vl.box">
                            {{ vls.name }} 
                            <span class="QYdel" @click="delLocation(vls.id, vls.count, 3)" value="删除"></span>
                            <span class="QYbianji" @click="editLocation(vls, {l:index,r:k,b:n,ac:'editBox'}, 3)" value="编辑" ></span>
                        </div>
                    </div>
                </td>    
                <td>
                    <Button type="success" @click="addRack(line.id)">添加档案架</Button>

                    <Button type="warning" @click="addBox(index, line.id)" v-if="line.rack.length">添加档案盒</Button>
                </td>
